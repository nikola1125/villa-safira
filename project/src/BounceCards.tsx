  ...
  return (
    ...
    >
      {images.map((src, idx) => (
        ...
        >
          <div
            className="w-40 h-40 sm:w-56 sm:h-56 md:w-[240px] aspect-square border-4 sm:border-8 border-ivory rounded-xl sm:rounded-[30px] overflow-hidden shadow-xl shadow-warmBlack/20"
          >
          ...
          {titles[idx] && (
            <div className="mt-3 px-3 py-1 bg-transparent">
              <span className="text-warmBlack text-[11px] sm:text-sm md:text-base font-bold block text-center leading-tight whitespace-nowrap drop-shadow-[0_2px_2px_rgba(250,247,242,0.85)]">
                {titles[idx]}
              </span>
            </div>
          )}
