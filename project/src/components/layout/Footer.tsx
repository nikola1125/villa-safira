    ...
    return (
        <footer id="contact" className="relative overflow-hidden bg-gradient-to-b from-cream via-navyMid to-navy text-white pt-24 pb-12 snap-start scroll-mt-24">
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        'url("data:image/svg+xml,%3Csvg viewBox=\'0 0 256 256\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noise\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.75\' numOctaves=\'4\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%25\' height=\'100%25\' filter=\'url(%23noise)\'/%3E%3C/svg%3E")',
            ...
            <div
                ...
                style={{
                    backgroundImage: 'radial-gradient(circle at 50% 0%, rgba(0,0,0,0) 0%, rgba(0,0,0,0.4) 70%, rgba(0,0,0,0.65) 100%)',
                }}
            />
            <div className="max-w-7xl mx-auto px-6 sm:px-12">
                            ...
                            <div className="flex gap-3">
                                {[
                                    ...
                                    <a
                                        ...
                                        className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/45 text-[10px] tracking-widest hover:border-gold/50 hover:text-gold transition-all duration-300"
                                        aria-label={label}
                                    >
                                        {label}
                                    </a>
                ...
                <div className="pt-10 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-6">
                    <p className="text-white/40 text-[10px] tracking-[0.3em] uppercase">
                        &copy; {new Date().getFullYear()} Villa Safira · Durrës, Albania
                    </p>
