        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[200] bg-navy/80 backdrop-blur-xl flex flex-col items-center justify-center p-4"
                ...
                >
                    ...
                    <button
                        ...
                        className="absolute top-6 right-6 w-11 h-11 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-white hover:bg-gold/20 hover:border-gold/40 transition-all duration-300 z-[210]"
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        transition={{ duration: 0.3 }}
                        className="w-full max-w-5xl px-4 sm:px-20"
                    ...
                    {/* Counter */}
                    <div
                        className="mt-6 text-white/40 text-xs tracking-[0.3em] uppercase font-sans"
                        onClick={(e) => e.stopPropagation()}
                    >
                    ...
                    {/* Thumbnail strip */}
                    <div
                        className="flex gap-2 mt-4 px-4 overflow-x-auto scrollbar-hide max-w-2xl"
                        onClick={(e) => e.stopPropagation()}
                    >
                        {images.map((img, i) => (
                            <button
                                ...
                                className={`flex-shrink-0 w-12 h-9 rounded overflow-hidden transition-all duration-200 ${i === index
